  ...
  const fetchTransactions = async () => {
    ...
    try {
      const response = await axios.get(
        `${BaseUrl}/user/getAllDoctorProfileIds?page=${currentPage}`,
        {
          headers: {
    ...
    <Card border="light" className="table-wrapper table-responsive shadow-sm">
      ...
      {showDeleteModal && (
        <CommonDeleteModal
          ...
          deleteUrl={`${BaseUrl}/user/doctorProfileDelete`}
        />
      )}
    </Card>
  );
...
export const TransactionsPharmacyTable = () => {
  ...
  const fetchTransactions = async () => {
    ...
    try {
      const response = await axios.get(
        `${BaseUrl}/user/getAllPharmacyProfile?page=${currentPage}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    <Card border="light" className="table-wrapper table-responsive shadow-sm">
      ...
      {showDeleteModal && (
        <CommonDeleteModal
          ...
          onDelete={handleDeleteSuccess}
          show={showDeleteModal}
          deleteUrl={`${BaseUrl}/user/pharmacyProfileDelete`}
        />
      )}
    </Card>
  );
